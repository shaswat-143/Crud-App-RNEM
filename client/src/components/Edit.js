...
const Edit = () => {
   ...
   const {updata, setUPdata} = useContext(updatedata)
    ...
    const updateuser = async(e)=>{
        ...
        const {name,email,work,add,mobileno,desc,age} = inpval;
        ...
        const res2 = await fetch(`/updateuser/${id}`,{
            ...
            body:JSON.stringify({
                name,email,work,add,mobileno,desc,age
            })
        });
            ...
            <form className="mt-4">
                <div className="row">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                        ...
                        <input type="number" value={inpval.mobileno} onChange={setdata} name="mobileno" class="form-control" id="exampleInputPassword1" />
                    </div>
                    <div class="mb-3 col-lg-6 col-md-6 col-12">
